...
class Jersey extends Model
{
    ...
    protected $fillable = [
        'first_name', 'last_name', 'email', 'mobile_number','personal_info','jersey_specifications',
        'jersey_size','sleeves','number', 'left_chest_logo_image', 'right_chest_logo_image', 'left_logo', 'right_logo',
